...
/**
 * This trait defines portable types among different languages, along with their Scala conversions. Actual
 * platform-specific implementations of the polyglot API should incarnate these types with the appropriate
 * language-specific ones and provide, for each of them, the required Scala conversions.
 */
trait PortableTypes:
  ...
  /** A portable Seq that can be used across different languages. */
  type Seq[V]
  ...
  /** A portable 0-argument function type that can be used across different languages. */
  type Function0[R]

  /** Portable functions at 0-argument can be converted to Scala's `() => R`. */
  given toScalaFunction0[R]: Conversion[Function0[R], () => R]

  /** A portable 1-argument function type that can be used across different languages. */
  type Function1[T1, R]
  ...
  /** A portable 2-argument function type that can be used across different languages. */
