...
/** A safe iterable is an iterable that provides only safe operations. Safe
  * operations are those that do not throw exceptions when the iterable is
  * empty. For example, the `head` method of the [[Iterable]] trait throws an
  * exception when the iterable is empty.
  * @tparam A
...
trait SafeIterable[+A]:
  ...
  /** Returns the minimum element of this iterable, according to the ordering of
    * the elements. If the iterable is empty, returns the upper bound of the
  ...
  /** Returns the maximum element of this iterable, according to the ordering of
    * the elements. If the iterable is empty, returns the lower bound of the
    * type of the elements.
    * @see
    *   [[LowerBounded]]
    * @tparam B
