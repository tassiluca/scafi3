...
/** A bidirectional function is a function that can be applied in two
  * directions. It is useful to define a function and its inverse in a single
  * object.
  * @tparam A
  *   the input type
  * @tparam B
...
object BidirectionalFunction:
  ...
  /** Creates a bidirectional function from a forward function. The backward
