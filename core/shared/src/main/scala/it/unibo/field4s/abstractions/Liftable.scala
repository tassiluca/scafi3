...
/** A type class that provides ways to combine collections of values into new
  * collections of values.
  * @tparam F
  *   the type of the collection
  */
trait Liftable[F[_]] extends Mappable[F]:
  /** Maps a collection of values to a new collection of values by applying a
    * function to each value.
    */
  def lift[A, B](a: F[A])(f: A => B): F[B]

  /** Combines two collections of values into a new collection of values by
    * applying a function to each pair of values.
    */
  def lift[A, B, C](a: F[A], b: F[B])(f: (A, B) => C): F[C]

  /** Combines three collections of values into a new collection of values by
    * applying a function to each triple of values.
    */
...
object Liftable:
  ...
  /** Maps a collection of collections of values to a new collection of
    * collections of values by applying a function to each value.
    * @param a
  ...
  /** Combines two collections of collections of values into a new collection of
    * collections of values by applying a function to each pair of values.
    * @param a
  ...
  /** Combines three collections of collections of values into a new collection
    * of collections of values by applying a function to each triple of values.
    * @param a
    *   the first collection of collections of values
    * @param b
    *   the second collection of collections of values
