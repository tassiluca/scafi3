...
/** Type class testifying that a collection of elements is an aggregate of
  * distributed values coming from neighbours. It provides extension methods to
  * work with the aggregate.
  * @tparam F
