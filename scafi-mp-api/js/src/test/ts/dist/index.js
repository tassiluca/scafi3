...
class Foo {
    instance;
    constructor(name, id) {
        this.instance = (0, protobuf_1.create)(foo_pb_js_1.FooSchema, { name, id });
    }
    get codable() {
        return Foo.codable;
    }
    static codable = {
        typeName: "Foo",
        encode: (foo) => (0, protobuf_1.toBinary)(foo_pb_js_1.FooSchema, foo.instance),
        decode: (bytes) => {
            const decodedFoo = (0, protobuf_1.fromBinary)(foo_pb_js_1.FooSchema, bytes);
