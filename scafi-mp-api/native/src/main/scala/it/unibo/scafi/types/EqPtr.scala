...
import scala.scalanative.unsafe.{ CBool, CFuncPtr1, CFuncPtr2, CVoidPtr }
 ...
 */
class EqPtr(val ptr: CVoidPtr, val equals: CEquals, val hash: CHash):
  override def equals(obj: Any): Boolean = obj match
    case other: EqPtr => equals(this.ptr, other.ptr)
    case _ => false
  override def hashCode(): Int = hash(ptr).toInt
  override def toString: String = s"EqPtr($ptr)"
